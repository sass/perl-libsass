...
my $r;
$r = Text::Sass::XS::compile_sass("this is invalid sass source", {});
...
$r = Text::Sass::XS::compile_sass(".valid { color: red; }", {});
...
$r = Text::Sass::XS::compile_sass(".valid { color: red; }", { output_style => Text::Sass::XS::SASS_STYLE_NESTED });
...
$r = Text::Sass::XS::compile_sass("\n.valid {\n color: red; }", { output_style => Text::Sass::XS::SASS_STYLE_COMPRESSED });
...
$r = Text::Sass::XS::compile_sass('@import "colors"; .valid { color: $red; }', { });
...
$r = Text::Sass::XS::compile_sass('@import "colors"; .valid { color: $red; }', { include_paths => 't/inc' });
...
$r = Text::Sass::XS::compile_sass('@import "colors"; .valid { color: $red; }', { include_paths => 't/nonexistent:t/inc' });
...
$r = Text::Sass::XS::compile_sass('.valid { color: image-url("path"); }', { image_path => "/a/b/c" });
